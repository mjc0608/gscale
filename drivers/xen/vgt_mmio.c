...
reg_attr_t vgt_temp_reg_info[] = {
	/* RCS */
{0x2000, 0x1000, F_RDR, 0, D_ALL, NULL, NULL},
	/* VCS */
{0x12000, 0x1000, F_RDR, 0, D_ALL, NULL, NULL},
	/* BCS */
{0x22000, 0x1000, F_RDR, 0, D_ALL, NULL, NULL},
	/* display pallete registers */
{0x4A000, 0x3000, F_DPY, 0, D_ALL, NULL, NULL},
	/* PIPE control */
{0x60000, 0x10000, F_DPY, 0, D_ALL, NULL, NULL},
	/* Plane and cursor control */
{0x70000, 0x10000, F_DPY, 0, D_ALL, NULL, NULL},
	/* display watermark */
{0x45100, 0x30, F_DPY, 0, D_ALL, NULL, NULL},
	/* backlight */
{0x48250, 0x20, F_DPY, 0, D_ALL, NULL, NULL},
	/* panel power sequence */
{0xC7200, 0x10, F_DPY, 0, D_ALL, NULL, NULL},
	/* PCH shared functions (gmbus, gpio, clock, power seq, backlight) */
{0xC0000, 0x7210, F_DPY, 0, D_ALL, NULL, NULL},
	/* PCH transcoder and port control */
{0xE0000, 0x5000, F_DPY, 0, D_ALL, NULL, NULL},
	/* PCH transcoder and FDI control */
{0xF0000, 0x3000, F_DPY, 0, D_ALL, NULL, NULL},
	/* FDI PLL control */
...
{_REG_CACHE_MODE_0, 4, F_RDR_MODE, 0, D_SNB, NULL, NULL},
{_REG_CACHE_MODE_1, 4, F_RDR_MODE, 0, D_SNB, NULL, NULL},
{_REG_CACHE_MODE_0_IVB, 4, F_RDR_MODE, 0, D_GEN7PLUS, NULL, NULL},
...
/* TODO: need a handler */
{_REG_RCS_PP_DIR_BASE_READ, 4, F_RDR_ADRFIX, 0xFFFF0000, D_SNB, NULL, NULL},
{_REG_RCS_PP_DIR_BASE_WRITE, 4, F_RDR_ADRFIX, 0xFFFF0000, D_SNB, NULL, NULL},
{_REG_RCS_PP_DIR_BASE_IVB, 4, F_RDR_ADRFIX, 0xFFFF0000, D_IVB, NULL, NULL},
...
{_REG_GTFIFODBG, 4, F_VIRT, 0, D_ALL, NULL, NULL},
...
{_REG_FDI_RX_LANE0_LSB_DRC_CTRL, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_MSB_DRC_CTRL, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_LSB_DRC_CTRL+0x18, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_MSB_DRC_CTRL+0x18, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_LSB_DRC_CTRL+0x18*2, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_MSB_DRC_CTRL+0x18*2, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_LSB_DRC_CTRL+0x18*3, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE0_MSB_DRC_CTRL+0x18*3, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_LSB_DRC_CTRL, 4, F_VIRT, 0, D_ALL, NULL, NULL},
{_REG_FDI_RX_LANE4_MSB_DRC_CTRL, 4, F_VIRT, 0, D_ALL, NULL, NULL},
{_REG_FDI_RX_LANE4_LSB_DRC_CTRL+0x18, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_MSB_DRC_CTRL+0x18, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_LSB_DRC_CTRL+0x18*2, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_MSB_DRC_CTRL+0x18*2, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_LSB_DRC_CTRL+0x18*3, 4, F_VIRT, 0, D_SNB, NULL, NULL},
{_REG_FDI_RX_LANE4_MSB_DRC_CTRL+0x18*3, 4, F_VIRT, 0, D_SNB, NULL, NULL},
...
{_REG_DP_LOAD_STROBE, 4, F_VIRT, 0, D_SNB, NULL, NULL},
